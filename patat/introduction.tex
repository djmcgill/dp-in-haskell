...
\AJP{Add comment that single core machines are NOT becoming more powerful, but have essentially stalled - instead the push is towards multi-core or even 1000s of cores on the cloud. Parallel code is notoriously hard to write and get correct. Better programming language support will become more essential.}
...
and HSBC Private Bank\footnote{http://www.lexifi.com/quotes}.

\AJP{TODO: say that the above are `executable specifications' ?}
